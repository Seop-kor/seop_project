...
import static com.one.geoar.util.DefaultConfigs.DEFAULT_ACTIVITY;
import static com.one.geoar.util.DefaultConfigs.DEFAULT_AR_FEATURES;
import static com.one.geoar.util.DefaultConfigs.DEFAULT_CAMERA_2_ENABLED;
import static com.one.geoar.util.DefaultConfigs.DEFAULT_CAMERA_FOCUS_MODE;
import static com.one.geoar.util.DefaultConfigs.DEFAULT_CAMERA_POSITION;
import static com.one.geoar.util.DefaultConfigs.DEFAULT_CAMERA_RESOLUTION;

...
public class TransActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent it = getIntent();
        switch(SettingActivity.selectedlan){
            case "ko":
                tv_Lang.setText("한국어");
                break;
            case "en":
            ...
            case "ja":
                ...
                break;
            case "es":
                tv_Lang.setText("español");
                break;
            case "vi":
                tv_Lang.setText("tiếng Việt");
                break;
        }

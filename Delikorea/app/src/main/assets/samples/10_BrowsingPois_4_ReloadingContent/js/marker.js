...
function Marker(poiData) {
    ...
    */
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(11), 0.8, {
        zOrder: 1,
        translate: {
            y: 0.10
        },
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(10), 0.6, {
        zOrder: 1,
        translate: {
            y: -0.60
        },
...
Marker.prototype.setDeselected = function(marker) {
    ...
    if (marker.animationGroupIdle === null) {
        ...
        var showIdleDrawableAnimation = new AR.PropertyAnimation(
            marker.markerDrawableIdle, "opacity", null, 0.4, changeAnimationDuration);
